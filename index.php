        ...
        <div id="top-banner-1" class="banner">
          <div class="banner-inner-wrapper header-text">
            <div class="main-caption">
              ...
              <h1>Caribbean</h1>
              <div class="border-button"><a href="package.php">Go There</a></div>
            </div>
            <div class="container">
              <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-3 col-sm-6 col-6">
                        <div class="main-button">
                          <a href="package.php">Explore More</a>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-lg-8 col-sm-7">
                      <div class="right-content">
                        ...
                        <div class="text-button">
                          <a href="package.php">Need Directions ? <i class="fa fa-arrow-right"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
